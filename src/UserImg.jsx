...
function UserImg() {
  ...
  const [imagerimg,Setimagerimg]=useState("https://funmauj.b-cdn.net/test/873098.jpg")
  ...
  function HandleInput(e){
    ...
    }else if (name=="userimgfile1") {
      setformData(( prev)=>({
        ...prev,
      }))
      
    }else if (name=="userimgfile2") {
  ...
  return (
    <>
          ...
          <div id='img-pop-up' className='hidden border-2 border-double border-black' >
            ...
            <div id='cross-img' className='flex justify-end'><img src="iconcross.png" alt="cross image" /></div>
      ...
      <div className='ml-8'>
        ...
        <div className=' lg:flex justify-centre items-center   lg:w-[40rem]'>
        {/* flex w-[40rem] */}
          {/* <div className='border-rounded border-slate-100'><img className='w-65 h-130' src="riya.png" alt="" /></div> */}
          {/* sm:flex-row */}
          <div className='mb-4'>
          {/* girlimg */}
            <img className='w-[30rem] h-[26rem] cursor-pointer' src={image} alt="" onClick={()=>{
              // imgsrc(girlimg[i])
              // girlimg
              setCount(count+1)}} onDoubleClick={()=>{setCount(count+1)}}/>
              <div className='border-4 border-amber-300 mt-2'>
                <label htmlFor="Choose Your photo">Choose Your photo</label> 
                <input type="file" className=' sm:ml-4 lg:mt-2 lg:ml-0' onChange={HandleInput}  name="userimgfile1" id="" />
                <input type="submit" value="Submit" className='lg:mt-2 border-4 border-amber-500 cursor-pointer ' />
              </div>
            <div className='flex mt-4'>
              <div>
                <div className='flex'>
                  <img className='mt-6 cursor-pointer' src="like.png" onClick={()=>{
              setCount(count+1)}} alt="" /> 
                  <p className='ml-8 mt-12 text-5xl'>{count}</p></div>
              <p className='mt-4'> Like</p>
              </div>
              <div>
                <div className='flex'>
                  <img className='mt-10 ml-20 cursor-pointer' src="dislike.png" onClick={()=>{
                  setCount1(count1+1)
                  console.log("liked!")}} alt="" /> 
          ...
          {/* https://cdn.pixabay.com/photo/2020/03/31/19/20/dog-4988985_1280.jpg */}
            <img className='w-[28rem] h-[26rem] cursor-pointer' src={imagerimg} alt="" onClick={()=>{
                  setCount1(count1+1)
              ...
              <div className='border-4 border-amber-300 mt-2'>
                <label htmlFor="Choose Your photo">Choose Your photo</label> 
                <input type="file" className='sm:ml-4 lg:mt-2 lg:ml-0' name="userimgfile2" onChange={HandleInput} id="" />
                <input type="submit" value="Submit" className='lg:mt-2 border-4  border-amber-500 cursor-pointer' />
              </div>
            <div className='flex mt-4'>
              <div>
                <div className='flex'>
                <img className='mt-4 cursor-pointer' src="like.png" onClick={()=>{
                  setCount1(count1+1)
                  console.log("liked!")}} alt="" /> 
              ...
              <div>
                <div className='flex'>
                  <img className='mt-6 ml-20 cursor-pointer' src="dislike.png" onClick={()=>{
              setCount(count+1)}} alt="" /> 
